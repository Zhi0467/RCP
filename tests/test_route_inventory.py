...
_FROZEN_ROUTE_INVENTORY: tuple[RouteEntry, ...] = (
    ...
    (("GET",), "/api/projects/{project_id}/chat-archives"),
...
_HANDLER_MODULE_MAP: dict[str, str] = {
    "provider_logins": "src/rcp/api/provider_login.py",
    "verify_provider_login": "src/rcp/api/provider_login.py",
    "start_provider_sign_in": "src/rcp/api/provider_login.py",
    "provider_sign_in_status": "src/rcp/api/provider_login.py",
    "cancel_provider_sign_in": "src/rcp/api/provider_login.py",
    "save_provider_token": "src/rcp/api/provider_login.py",
    "sign_out_provider_login": "src/rcp/api/provider_login.py",
    "agent_task": "src/rcp/api/tasks.py",
    "accept_artifact_revision_candidate": "src/rcp/api/tasks.py",
    "content_agent_artifact": "src/rcp/api/tasks.py",
    "content_artifact_revision_candidate": "src/rcp/api/tasks.py",
    ...
    "archive_episode": "src/rcp/api/episode_routes.py",
    "browse_project_setup_ssh_paths": "src/rcp/api/index.py",
    ...
    "conversation_worktree_controls": "src/rcp/api/chats.py",
    "delete_conversation_worktree": "src/rcp/api/chats.py",
    ...
    "episode_timeline": "src/rcp/api/episode_routes.py",
    "episode_timeline_body": "src/rcp/api/episode_routes.py",
    "exchange_team_session": "src/rcp/api/team.py",
    "create_team_device_pairing": "src/rcp/api/team.py",
    "team_device_pairing_status": "src/rcp/api/team.py",
    ...
    "project_experiment_episodes": "src/rcp/api/index.py",
    "preview_agent_artifact": "src/rcp/api/tasks.py",
    "preview_episode_report": "src/rcp/api/episode_routes.py",
    "save_episode_report": "src/rcp/api/episode_routes.py",
    ...
    "continue_episode": "src/rcp/api/episode_routes.py",
    ...
    "reject_artifact_revision_candidate": "src/rcp/api/tasks.py",
    ...
    "cancel_watcher": "src/rcp/api/watchers.py",
    "sync_graph": "src/rcp/api/sync.py",
    "team_invitations": "src/rcp/api/team.py",
    "team_sessions": "src/rcp/api/team.py",
    ...
    "check_machine_compute": "src/rcp/api/project_state.py",
    "archived_chats": "src/rcp/api/chats.py",
    "archive_chat": "src/rcp/api/chats.py",
    ...
    "end_session": "src/rcp/api/terminals.py",
    "open_session": "src/rcp/api/terminals.py",
    "refresh_probes": "src/rcp/api/terminals.py",
    "repositories": "src/rcp/api/terminals.py",
    "sessions": "src/rcp/api/terminals.py",
}
...
def test_frozen_route_inventory(route_app: FastAPI) -> None:
    ...
    assert len(_FROZEN_ROUTE_INVENTORY) == 158
    ...
    assert sum(isinstance(route, APIRoute) for route in routes) == 154
