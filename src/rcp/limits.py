...
# Live Work-patch self-validation through the run-stage file mailbox.
WORK_PATCH_SELF_CHECK_MAX_COUNT = 6
WORK_PATCH_SELF_CHECK_POLL_SECONDS = 0.2
WORK_PATCH_SELF_CHECK_TIMEOUT_SECONDS = 30
WORK_PATCH_SELF_CHECK_MAX_REQUEST_BYTES = 16 * 1024 * 1024
