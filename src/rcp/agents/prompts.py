...
- Cite a file with an ordinary Markdown link to its absolute path on its host, optionally suffixed
  `:line`. Only an authorized repository file or a file you wrote in the artifact directory opens
  in RCP's bounded preview; a relative path or any other location does not.
