...
RELATION_SPEC: dict[BaseRelation, RelationSpec] = {
    "has_subquestion": RelationSpec(
        ...
        frozenset({"research_question"}),
        "epistemic",
        description="The target question is part of answering the source question.",
    ),
    "has_hypothesis": RelationSpec(
        frozenset({"research_question"}),
        frozenset({"hypothesis"}),
        "epistemic",
        description="The Hypothesis is a candidate answer to the question.",
    ),
    "supports": RelationSpec(
        frozenset({"evidence"}),
        frozenset({"hypothesis"}),
        "epistemic",
        description="The Evidence makes the claim more likely.",
    ),
    ...
    "inconclusive": RelationSpec(
        ...
        frozenset({"hypothesis"}),
        "epistemic",
        description="The Evidence bears on the claim but settles nothing either way.",
    ),
    "contradicts": RelationSpec(
        frozenset({"evidence", "hypothesis"}),
        frozenset({"hypothesis"}),
        "epistemic",
        description="The source, Evidence or another Hypothesis, is incompatible with the claim.",
    ),
    "tests": RelationSpec(
        frozenset({"experiment"}),
        frozenset({"hypothesis"}),
        "seam",
        description="The Experiment can tell whether the claim holds.",
    ),
    ...
    "informs": RelationSpec(
        ...
        frozenset({"decision"}),
        "action",
        description="The Evidence bears on the choice. It neither selects an option nor closes the Decision.",
    ),
    ...
    "has_decision": RelationSpec(
        ...
        frozenset({"decision"}),
        "action",
        description="The choice belongs to the question.",
    ),
    ...
    "blocked_by": RelationSpec(
        ...
        frozenset({"blocker"}),
        "action",
        description="The open Blocker keeps the source from proceeding; a blocked Experiment cannot start.",
    ),
    "requires_decision": RelationSpec(
        frozenset({"blocker"}),
        frozenset({"decision"}),
        "action",
        description="Clearing the Blocker needs this choice.",
    ),
