...
In the source-built desktop, **Add team space → Bootstrap or invitation code**
collects that person's SSH target, display name, and bootstrap or invitation code. The SSH
