...
last_checked: >-
  2026-09-05 — an isolated served-app drive showed Resume before End and merge
  to main, then Stopped and Merged with no Resume/Retry in either episode or
  task detail. The stage and patch remained intact; browser console and merge
  requests were clean. Focused regressions cover permanent ending on merge
  failure, concurrent Resume, admission rollback, and unresolved child refusal.
