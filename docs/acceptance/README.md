...
| [S26](S26-delete-project.md) | Delete an RCP project without deleting the research project | pending | pytest + browser |
...
| [S139](S139-root-wakes-coalesce.md) | One worker settlement costs the orchestrator one paid wake | implemented | pytest |
