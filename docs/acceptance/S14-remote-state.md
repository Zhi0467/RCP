...
in the [canonical publication contract](../specs/graph-history-and-transitions.md#canonical-publication)
and implemented in
[`_reconcile_remote_publish_failure`](../../src/rcp/history/manager.py), and
