...
**Glossary**, **Paper**, and **Settings**. Inbox carries its current attention
count in a colored badge. DAG is not a primary tab: Research owns a compact
**Research / DAG** subpanel switch. Glossary and Paper use visibly different
icons.
...
3. Open Inbox and confirm its badge matches the unresolved attention count.
...
- `project_chat_is_ask`
- `inbox_has_colored_attention_count`
- `dag_is_a_research_subpanel`
- `glossary_and_paper_icons_are_distinct`
