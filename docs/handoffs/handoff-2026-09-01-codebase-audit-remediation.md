...
steps 1 and 2 are implemented and verified on the remediation branch: H2 through
H6, H8, H9, and M15 through M21 are closed with focused regressions. Steps 3
