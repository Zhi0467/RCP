...
> [S77](../../acceptance/S77-auto-research-stops-at-belief.md) is `implemented`
> and [S78](../../acceptance/S78-one-budget-one-stop.md) is `implemented`, last
> driven in a browser 2026-08-14. Retained only as historical execution context;
> the canonical design lives in the blueprint's Auto-research section.
