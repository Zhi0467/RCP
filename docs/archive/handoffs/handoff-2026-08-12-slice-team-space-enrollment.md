...
> [S96](../../acceptance/S96-joining-a-team-space.md) was rewritten with the nine
> decisions below and is `implemented`. It was the first team slice; project
> membership then followed in
> [the membership slice](handoff-2026-08-15-slice-project-membership.md).
