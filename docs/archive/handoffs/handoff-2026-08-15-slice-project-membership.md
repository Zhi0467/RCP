...
> Archived 2026-08-17. Complete: both slices passed 2026-08-15 —
> [S101](../../acceptance/S101-project-membership.md) and
> [S122](../../acceptance/S122-project-invitations.md) are `implemented`. See
> "What the build changed" at the bottom for what the plan did not anticipate.
> Retained only as historical execution context.
