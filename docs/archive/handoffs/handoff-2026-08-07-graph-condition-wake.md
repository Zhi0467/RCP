...
> Archived 2026-08-17. Landed: the scope and rulings here became
> [S76](../../acceptance/S76-graph-condition-wake.md), which is `implemented` and
> last passed 2026-08-12; the implementation brief was
> [its dispatch](handoff-2026-08-12-dispatch-graph-condition-wake.md). The
> "no acceptance scenario, no code" state described below is long out of date.
> Retained only as historical design context; the canonical design lives in
