...
> Archived 2026-08-17. Landed as Auto-research:
> [S77](../../acceptance/S77-auto-research-stops-at-belief.md) and
> [S78](../../acceptance/S78-one-budget-one-stop.md) are both `implemented` (S78
> last driven 2026-08-14), built from
> [its dispatch](handoff-2026-08-12-dispatch-orchestrator.md). Piece 1 and piece 2
> of the program landed too, so the sequencing warnings below no longer apply, and
> the "no code exists" state does not. Retained only as historical design context;
